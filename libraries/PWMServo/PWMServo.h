...
class PWMServo
{
  ...
  public:
    PWMServo();
    virtual uint8_t attach(int pinArg) { return attach(pinArg, 544, 2400); }
    ...
    virtual void detach();
    virtual void write(int angleArg); // specify the angle in degrees, 0 to 180
    virtual uint8_t read() { return angle; }
    virtual uint8_t attached();
};
